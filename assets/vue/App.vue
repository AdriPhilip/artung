...
export default {
  ...
  created() {
    // Stockage du appAccessToken (API-ID + APP-SECRET) pour test
    /* window.appAccessToken =
      '113324356787500' + '|' + 'a37482071c19a6e0555b5476d7a84d49';
    //"113324356787500|2nUUOk0wWhd5qUcWUUgCkiCH5E8";
    // Chargement du SDK Facebook pour accéder à FB.api()
    this.loadFbSdk('113324356787500', 'v5.0'); */
